					  		...
					  		<c:forEach var ="reservation" items="${MyreservationListPage.content}"> <!-- 예약 내역이 있다면 -->
						  		<tr>
						  			...
						  			<td width ="140" >
						  				...
						  				<button type="button" class="operate_btn" name="operate"  value="후기작성"  onclick="location.href='<%=request.getContextPath()%>/writeReview.do?reNo=${reservation.reserve_no}&rName=${reservation.room_name}&pageNo=${MyreservationListPage.currentPage}';">
						  				후기작성</button>
						  				</c:if>
